...
""" Python handles lists using the List type, known as lists, "List". """
# List in Python are the most versatile and flexible data type in Python.
#   Are mutable, ordered, and allow duplicate elements.
#       Defined by enclosing elements in square brackets [].
...
#       Includes all items, including empty ones.
...
""" Glue together two or more list using the "+" operator. """
...
# [1, 2, 3, 1, 2, 3, 4, 5, 6, 4, 5, 6, 7, 8, 9, 10] 

""" Automatic concatenation of list literals """
# Two o more list next to each other are automatically concatenated.
